  ...
  return (
    <div className="group bg-white rounded-2xl border border-[#e8e4df] overflow-hidden hover:shadow-[0_4px_24px_rgba(14,28,61,0.08)] transition-shadow duration-200">
      ...
      <div className="relative h-44 bg-[#f0ede8] overflow-hidden">
        ...
        {r.neighborhood && (
          <span className="absolute top-3 left-3 px-2.5 py-1 bg-white/90 backdrop-blur-sm text-[10px] font-sans font-medium text-[#0e1c3d] rounded-full border border-white/60">
            {r.neighborhood}
          </span>
        )}
      </div>
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-start justify-between gap-3">
          <h2 className="font-serif text-lg font-semibold text-[#0e1c3d] leading-tight">
            {r.name}
          </h2>
              ...
              return (
                <a
                  ...
                  className={cn(
                    ...
                    i === 0
                      ? "bg-[#0e1c3d] text-white border-[#0e1c3d] hover:bg-[#1a3160]"
                      : "bg-white text-[#0e1c3d] border-[#c8d4e8] hover:bg-[#f0f4fb]"
                  )}
                >
                  {slot.time}
                  {slot.type && (
